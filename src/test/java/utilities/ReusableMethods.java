...
public class ReusableMethods {
  ...
  //  static AndroidDriver<AndroidElement> driver=Driver.getAppiumDriver();
    ...
    public static void scrollWithUiScrollable(String elementText) {
        ...
        driver.findElement(new AppiumBy.ByAndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"" + elementText + "\"))"));
    ...
    public static void KordinatlaTiklama(){

        final var finger = new PointerInput(PointerInput.Kind.TOUCH, "finger");
        var tapPoint = new Point(208, 1909);
    ...
    public static void orderHistoryKoordinatTiklama(){

        final var finger = new PointerInput(PointerInput.Kind.TOUCH, "finger");
        var tapPoint = new Point(597, 584);
        var tap = new Sequence(finger, 1);
        tap.addAction(finger.createPointerMove(Duration.ofMillis(0),
                PointerInput.Origin.viewport(), tapPoint.x, tapPoint.y));
        tap.addAction(finger.createPointerDown(PointerInput.MouseButton.LEFT.asArg()));
